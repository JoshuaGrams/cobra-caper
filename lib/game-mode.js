var GameMode = (function() {
	...
	// You probably also want a `key` function that returns `state` if
	// `GameMode.arrowKeys[key]` is true (to eat the key events so e.g.
	// Firefox's "search when you type" doesn't steal focus).
